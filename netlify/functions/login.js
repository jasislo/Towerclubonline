document.addEventListener('DOMContentLoaded', () => {
    ...
    async function checkAuth() {
        try {
            const { getAuthData } = await import('../../scripts/aut-utils.js');
            const { checkAuthStatus } = await import('../../scripts/auth-api.js');
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const { loginUser } = await import('../../scripts/auth-api.js');
            const { storeAuthData } = await import('../../scripts/aut-utils.js');
